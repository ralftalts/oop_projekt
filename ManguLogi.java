...
import java.util.List;
 ...
 // Klass ManguLogi – kirjutab iga käigu CSV-faili ja võimaldab käike tagasi võtta.
...
public class ManguLogi {
    ...
    public ManguLogi(String mangijanimi) {
        ...
        // Failinimi: mängija nimi + ajatempel
    ...
    // Tagastab true, kui on vähemalt üks vastamine failis olemas.
    ...
    public List<LogiKirje> loeKoikKirjed() {
        ...
        try (BufferedReader lugeja = new BufferedReader(new FileReader(failiTee))) {
            ...
            // Faili lugemisel probleem – tagastab tühja nimekirja
        }
        return kirjed;
    }
    ...
    private void kirjutaRida(String rida) {
        try (PrintWriter kirjutaja = new PrintWriter(new FileWriter(failiTee, true))) {
            ...
            System.err.println("Hoiatus: logifaili kirjutamine ebaõnnestus: " + e.getMessage());
        }
    }

    // Ühe käigu andmete hoidmiseks
